...
This plan covers cleaning up existing finding model definitions (primarily GMTS, CDE, and MGB sources) to align with the conventions in `prompts/conventions.md`. This is a separate workstream from creating new models.
